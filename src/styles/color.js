export const blue = '#0058b6';
export const _purple = '#9c27b0';
export const _lightGreen = '#7cb342';
// ('rgba(0, 88, 182, 0.5)');
('rgba(157, 39, 176, 0.5)');
// antdesign - shoppingcart
// entypo - chevron-thin-down, dots-three-vertical, menu, shoppig-basket, bell
// evilicons - bell, cart, chevron-down, credit-card, navicon, plus, search, spinner(2, 3), user,
// 	feather - menu, more-vertical, shopping-bag, shopping-cart
// fontaesome - navicon, long-arrow-right,
